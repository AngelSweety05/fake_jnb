    ...
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        if message.from_user.id in ADMINS:
            buttons = [
                ...
                InlineKeyboardButton('⪦ 🎬 ᴍᴏᴠɪᴇ ᴄʜᴀɴɴᴇʟ 🎞 ⪧', url='https://t.me/jollygymkhanamovie')
                ],[
...
async def plan(client, message):
    ...
    await message.reply_photo(photo="https://i.ibb.co/T40gsR6/janascanner.jpg", caption=script.PLANS_TXT.format(message.from_user.mention, UPI_ID, QR_CODE_IMG), reply_markup=InlineKeyboardMarkup(btn), parse_mode=enums.ParseMode.HTML)
