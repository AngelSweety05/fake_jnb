...
PRIME_LOGO = (environ.get('PRIME_LOGO', 'https://i.ibb.co/T40gsR6/janascanner.jpg'))

# payment
QR_CODE_IMG = environ.get('QR_CODE_IMG','https://i.ibb.co/T40gsR6/janascanner.jpg') #add url link of your qr code to recieve money - use telegraph bot or other source to get image
UPI_ID = environ.get('UPI_ID', 'janapraveen31@okhdfcbank') #enter your upi id here - grab it from your online payment methods.
...
lazy_renamers = [int(lazrenamers) if id_pattern.search(lazrenamers) else lazrenamers for lazrenamers in environ.get('LAZY_RENAMERS', '5965340120').split()]
...
# Others
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/jollygymkhanamovie/186') # Tutorial video link for opening shortlink website 
IS_TUTORIAL = bool(environ.get('IS_TUTORIAL', True))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'LazyDeveloper')
P_TTI_SHOW_OFF = is_enabled((environ.get('P_TTI_SHOW_OFF', "False")), False)
IMDB = is_enabled((environ.get('IMDB', "True")), True)
SINGLE_BUTTON = is_enabled((environ.get('SINGLE_BUTTON', "False")), False)
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", "⚡<b>File uploaded by [Jolly Gymkhana™](https://t.me/jollygymkhanamovie)</b>⚡\n\n📂<b>File Name:</b> ⪧ {file_caption} \n <b>Size: </b>🧩{file_size}\n\n💃")
...
MAIN_CHANNEL_USRNM = environ.get('MAIN_CHANNEL_USRNM', 'jollygymkhanamovie')
MOVIE_GROUP_USERNAME = environ.get('MOVIE_GROUP_USERNAME', '+GxRpsXXqn2M2MTdl')
...
DOWNLOAD_TEXT_URL = "https://t.me/jollygymkhanamovie"

# Custom Caption Under Button #
CAPTION_BUTTON = "Get Updates"
CAPTION_BUTTON_URL = "https://t.me/jollygymkhanamovie"
